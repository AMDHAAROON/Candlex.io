  ...
  return (
    <>
      <section className="pb-4" id="products">
        <div className="pb-8 relative px-8 bg-[linear-gradient(to_top_right,#ffba52_0%,#ffffff_50%,#ffba52_100%)] border-4 border-white w-full h-auto rounded-2xl">
            ...
            {Collections.map((item, index) => {
              ...
              return (
                ...
                >
                  ...
                  <div className=" md:block absolute bottom-0 w-full bg-[#4E3D28]/80 text-white flex justify-between items-center px-4 py-2 text-sm md:text-xl font-semibold opacity-100 transition-opacity duration-700">
                    <span>{item.name}</span>
                    <button className="bg-red-400 p-2 rounded-xl cursor-pointer hover:bg-white hover:text-red-400 font-bold hidden md:block ">
                        shop now
