    ...
    <>
      ...
      `}
              >
                ...
                />
                <div className="absolute bottom-0 w-full bg-[#4E3D28]/80 text-white flex justify-between items-center px-2 py-1 md:px-4 md:py-2 text-[12px] md:text-2xl font-semibold opacity-0 group-hover:opacity-100 transition-opacity duration-700">
                  <span>{item.name}</span>
