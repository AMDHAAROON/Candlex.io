      ...
      <div className="bg-gradient-to-br from-yellow-50 to-orange-100 min-h-screen flex flex-col items-center text-center px-6 py-16">
        ...
        <div data-aos="fade-down" className="max-w-3xl">
          ...
          <p className="text-lg md:text-xl text-gray-600">
            ...
            from you and light up new connections!
          </p>
        </div>
        ...
        <div
          data-aos="fade-up"
          className="mt-16 max-w-4xl bg-white shadow-xl rounded-2xl p-8 md:p-12"
        >
        ...
        <div
          data-aos="fade-up"
          className="md:ml-160 mt-20 mb-10 max-w-6xl w-full grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-6"
        >
          {services.map((service, idx) => (
            ...
            >
              <service.icon
                size={36}
                className="text-orange-500 mb-3 animate-bounce-slow"
              />
              <p className="text-[#4E3D28] font-semibold text-lg">
                {service.title}
              </p>
            </div>
          ))}
        ...
        >
          ...
          <form
            ...
            action="https://formspree.io/f/xblqzbjj"
            method="POST"
          >
            ...
            <textarea
              name="message"
              rows="4"
              placeholder="Leave your feedback that will be very helpful for us..."
              className="p-3 border border-orange-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-orange-400"
              required
            ></textarea>
