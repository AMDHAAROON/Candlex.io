...
export default function Faq() {
  ...
  const faqs = [
    {
      que: "Are your candles made with natural ingredients?",
      ans: "Yes, our candles are made using 100% natural soy wax and lead-free cotton wicks. We never use paraffin or harmful additives.",
    },
    {
      que: "Are your candles safe for pets and children?",
      ans: "Our candles are made with non-toxic ingredients, but we always recommend keeping them out of reach of pets and children while burning.",
    },
    {
      ...
      <Box
        sx={{
          ...
          "& .MuiPaper-root.MuiAccordion-root.Mui-expanded": {
            background: "linear-gradient(60deg, #Ffff, #ffcf85)",
            color: "#fff",
          },
        ...
        {currentFaq.map((item, index) => (
          ...
          >
            ...
            >
              <Typography
                variant="h3"
                sx={{ fontSize: { xs: "1rem", xl: "1.2rem" }, fontWeight: 600,color:"#4E3D28" }}
              >
